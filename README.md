...
Adapted from [Emily Laiken's merradownload](https://github.com/emilylaiken/merradownload), which builds on [Jan Urbansky's opendap_download](https://github.com/urbansky) and the [Open Power System Data](https://github.com/Open-Power-System-Data/weather_data/blob/master/download_merra2.ipynb) notebook. Edited and maintained by [Anemona](https://anemona.io).
